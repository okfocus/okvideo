...
"vimeo",b.id=a[1];return b};b.init()};a.okvideo.options={source:null,disableKeyControl:1,captions:0,loop:1,mute:null};a.fn.okvideo=function(c){return this.each(function(){new a.okvideo(c)})}})(jQuery);function vimeoPlayerReady(){for(var a=document.querySelectorAll("iframe"),c=0,b=a.length;c<b;c++)$f(a[c]).addEvent("ready",OKEvents.v.ready)}
...
OKEvents={yt:{ready:function(a){options.mute&&a.target.mute()},error:function(a){throw a;}},v:{ready:function(a){options.mute&&$f(a).api("api_setVolume",0)}}};
