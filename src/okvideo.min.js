...
"?api=1&js_api=1&title=0&byline=0&portrait=0&playbar=0&loop="+b.options.loop+'&autoplay=1&player_id=okplayer" frameborder="0" style="'+a(this).attr("style")+'visibility:hidden;background-color:black;" id="'+a(this).attr("id")+'"></iframe>'});b.insertJS("http://a.vimeocdn.com/js/froogaloop2.min.js",function(){vimeoPlayerReady()})};b.insertJS=function(b,a){var d=document.createElement("script");a&&(d.readyState?d.onreadystatechange=function(){if("loaded"==d.readyState||"complete"==d.readyState)d.onreadystatechange=
...
if(11==a.length)return{provider:"youtube",id:a};for(a=0;a<b.options.source.length;a++)if("number"!=typeof parseInt(b.options.source[a]))throw"not vimeo but thought it was for a sec";return{provider:"vimeo",id:b.options.source}}throw"OKVideo: Invalid video source";};b.init()};a.okvideo.options={source:null,disableKeyControl:1,captions:0,loop:1,hd:1,volume:0,adproof:!1};a.fn.okvideo=function(c){return this.each(function(){new a.okvideo(c)})}})(jQuery);
...
OKEvents={yt:{ready:function(a){a.target.setVolume(options.volume);a.target.playVideo()},error:function(a){throw a;}},v:{onPlay:function(){player.api("api_setVolume",options.volume)}}};
